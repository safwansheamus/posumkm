    ...
    <div class="custom-container">
        <div class="breadcrumb-content text-center">
            <ul>
                ...
                <li class="active"><?= $q ?> <?= $titleHead ?></li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="col-lg-9">
                <div class="shop-topbar-wrapper">
                    <div class="totall-product">
                        <p> Hasil Pencarian: <span></span> <?= $q ?></p>
                    </div>
                    <div class="sort-by-product-area">
                        ...
                        <div class="sort-by-dropdown">
                            <ul>
                                <li><a href="<?= base_url(); ?>search?q=<?= $q; ?>">Default</a></li>
                                <li><a href="<?= base_url(); ?>search?q=<?= $q; ?>&ob=latest">Terbaru</a></li>
                                <li><a href="<?= base_url(); ?>search?q=<?= $q; ?>&ob=az">A-Z</a></li>
                                <li><a href="<?= base_url(); ?>search?q=<?= $q; ?>&ob=za">Z-A</a></li>
                                <li><a href="<?= base_url(); ?>search?q=<?= $q; ?>&ob=pmin">Harga Terendah</a></li>
                                <li><a href="<?= base_url(); ?>search?q=<?= $q; ?>&ob=pmax">Harga Tertinggi</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="sidebar-wrapper sidebar-wrapper-mr1">
                    <div class="sidebar-widget sidebar-widget-wrap sidebar-widget-padding-1 mb-20">
                        ...
                        <div class="sidebar-brand-list">
                            <ul>
                                <li> <a href="<?= base_url(); ?>search?q=<?= $q; ?>&promo=true">Promo</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="sidebar-widget sidebar-widget-wrap sidebar-widget-padding-1 mb-20">
                        ...
                        <div class="sidebar-brand-list">
                            <ul>
                                <li><a href="<?= base_url(); ?>search?q=<?= $q; ?>&condition=1">Baru</a></li>
                                <li><a href="<?= base_url(); ?>search?q=<?= $q; ?>&condition=2">Bekas</a></a></li>
                            </ul>
                        </div>
                    </div>
