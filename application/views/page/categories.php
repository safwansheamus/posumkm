            ...
            <div class="col-lg-9">
                <div class="shop-topbar-wrapper">
                    <div class="totall-product">
                        <p> Kategori <span><?= $nameCat ?></span> Terbaik untuk kamu</p>
                    </div>
                    <div class="sort-by-product-area">
                        ...
                        <div class="sort-by-dropdown">
                            <ul>
                                ...
                                <li><a href="<?= base_url(); ?>c/<?= $slug ?>?ob=latest">Terbaru</a></li>
                                <li><a href="<?= base_url(); ?>c/<?= $slug ?>?ob=az">A-Z</a></li>
                                <li><a href="<?= base_url(); ?>c/<?= $slug ?>?ob=za">Z-A</a></li>
                                <li><a href="<?= base_url(); ?>c/<?= $slug ?>?ob=pmin">Harga Terendah</a></li>
                                <li><a href="<?= base_url(); ?>c/<?= $slug ?>?ob=pmax">Harga Tertinggi</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="sidebar-wrapper sidebar-wrapper-mr1">
                    <div class="sidebar-widget sidebar-widget-wrap sidebar-widget-padding-1 mb-20">
                        ...
                        <div class="sidebar-brand-list">
                            <ul>
                                <li> <a href="<?= base_url(); ?>c/<?= $slug ?>?promo=true">Promo</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="sidebar-widget sidebar-widget-wrap sidebar-widget-padding-1 mb-20">
                        ...
                        <div class="sidebar-brand-list">
                            <ul>
                                <li><a href="<?= base_url(); ?>c/<?= $slug ?>?condition=1">Baru</a></li>
                                <li><a href="<?= base_url(); ?>c/<?= $slug ?>?condition=2">Bekas</a></a></li>
                            </ul>
                        </div>
                    </div>
