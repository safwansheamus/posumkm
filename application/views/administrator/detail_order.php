...
<div class="container-fluid">
    ...
    <div class="card shadow mb-5">
        <div class="card-body">
            ...
            <a href="<?= base_url(); ?>administrator/finish_orderan/<?= $invoice['invoice_code']; ?>" onclick="return confirm('Yakin ingin menyelesaikan pesanan?');" class="btn btn-info btn-sm">Selesai</a>
            <?php } ?>
        </div>
    </div>
</div>
