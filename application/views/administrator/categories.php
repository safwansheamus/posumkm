				...
				>
					...
					<tbody class="data-content">
						...
						<tr>
                            ...
                            <td><?= $data['slug']; ?></td>
                            <td>
                                <a href="<?= base_url() ;?>administrator/category/<?= $data['id']; ?>" class="btn btn-sm btn-info"><i class="icon-pencil"></i></a>
                                <a href="<?= base_url() ;?>administrator/deleteCategory/<?= $data['id']; ?>" onclick="return confirm('Yakin ingin menghapus kategori? Semua produk dengan kategori ini akan ikut terhapus')" class="btn btn-sm btn-danger"><i class="icon-trash"></i></a>
                            </td>
                        </tr>
                        <?php $no++ ?>
                        <?php endforeach; ?>
