                        ...
                        <?php foreach($sosmed->result_array() as $d): ?>
                            <tr>
                                ...
                                <td style="width: 100px">
                                    <a href="<?= base_url() ;?>administrator/setting/sosmed/<?= $d['id']; ?>" class="btn btn-sm btn-info"><i class="icon-pencil"></i></a>
                                    <a href="<?= base_url() ;?>administrator/delete_sosmed/<?= $d['id']; ?>" onclick="return confirm('Yakin ingin menghapus sosmed ini?')" class="btn btn-sm btn-danger"><i class="icon-trash"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                   </table>
