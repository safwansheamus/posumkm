                ...
                <div class="card-body">
                   ...
                   <table class="table table-bordered">
                        ...
                        <?php
                            ...
                            CURLOPT_URL => "https://pro.rajaongkir.com/api/city?id=".$d['destination'],
                        ...
                        ?>
                            <tr>
                                ...
                                <td style="width: 100px">
                                    <a href="<?= base_url() ;?>administrator/setting/delivery/<?= $d['id']; ?>" class="btn btn-sm btn-info"><i class="icon-pencil"></i></a>
                                    <a href="<?= base_url() ;?>administrator/delete_delivery/<?= $d['id']; ?>" onclick="return confirm('Yakin ingin menghapus biaya antar ini?')" class="btn btn-sm btn-danger"><i class="icon-trash"></i></a>
                                </td>
                            </tr>
                        <?php $no++; endforeach; ?>
                   </table>
