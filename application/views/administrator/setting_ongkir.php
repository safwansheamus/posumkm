            ...
            <div class="card shadow">
                <div class="card-header">
                    <?php if($setting['ongkir'] == 0){ ?>
                        <a href="<?= base_url(); ?>administrator/setting/ongkir/status" class="btn btn-sm btn-primary float-left mr-2">Aktifkan Ongkir</a>
                    <?php }else{ ?>
                        <a href="<?= base_url(); ?>administrator/setting/ongkir/status" class="btn btn-sm btn-danger float-left mr-2">Matikan Ongkir</a>
                    <?php } ?>
                </div>
                <div class="card-body">
                    <form action="<?= base_url(); ?>administrator/setting/ongkir" method="post">
                        ...
                        <button type="submit" class="btn btn-info"><i class="fa fa-save"></i> Simpan Default</button>
                    </form>
                </div>
            </div>
        </div>
