                ...
                <div class="card-body">
                   ...
                   <table class="table table-bordered">
                        ...
                        <?php
                            ...
                            CURLOPT_URL => "https://pro.rajaongkir.com/api/city?id=".$d['regency_id'],
                        ...
                        ?>
                            <tr>
                                ...
                                <td style="width: 100px">
                                    <a href="<?= base_url() ;?>administrator/delete_cod/<?= $d['id']; ?>" onclick="return confirm('Yakin ingin menghapus COD ini?')" class="btn btn-sm btn-danger"><i class="icon-trash"></i></a>
                                </td>
                            </tr>
                        <?php $no++; endforeach; ?>
                   </table>
