                   ...
                   <table class="table table-bordered">
                        ...
                        <?php foreach($banner->result_array() as $d): ?>
                            <tr>
                                ...
                                <td><?= $d['url']; ?></td>
                                <td>
                                    <a href="<?= base_url() ;?>administrator/delete_banner/<?= $d['id']; ?>" onclick="return confirm('Yakin ingin menghapus banner ini?')" class="btn btn-sm btn-danger"><i class="icon-trash"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                   </table>
