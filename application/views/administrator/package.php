				...
				>
					...
					<tbody class="data-content">
						...
						<tr>
                            ...
                            <td>
								<a href="<?= base_url(); ?>administrator/package/<?= $data['id']; ?>" class="btn btn-sm btn-info"><i class="fa fa-eye"></i></a>
								<a href="<?= base_url(); ?>administrator/delete_package/<?= $data['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus paket ini?')"><i class="fa fa-trash"></i></a>
							</td>
                        </tr>
                        <?php $no++ ?>
                        <?php endforeach; ?>
